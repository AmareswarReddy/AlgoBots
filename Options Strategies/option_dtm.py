...
eg: let the time be 9:20AM and we found the volatility be 0.50
      ...
      if the volatility be 200 percent as the highest volatility for the day. we consider 200 percent as our max volatility for that perticular day like thursday or friday etc.,.
