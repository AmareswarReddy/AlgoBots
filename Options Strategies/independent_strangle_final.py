...
strategy=strategies(user="vinaykumar7295@gmail.com", passw="kittu1@A", dob="19700701",cred=cred)
Client=FivePaisaClient(email='vinaykumar7295@gmail.com', passwd='kittu1@A', dob='19700701',cred=cred)
Client.login()
#%%
'''
cred={
...
if day!=0:
    ...
    Current_PE_strikeprice=input('enter "PE" strikeprice')
    pe_mem=Current_PE_strikeprice
    Current_CE_strikeprice=input('enter "CE" strikeprice')
...
if day==0:
    strategy.iron_condor("banknifty",[str(CE_hedge),str(PE_hedge)],[str(PE_lower),str(CE_upper)],str(lots),expiry,'D',tag='rt')
    sleep(3)
    pe_mem=PE_lower
    ce_mem=CE_upper
    CE_req={'Exch': 'N',
